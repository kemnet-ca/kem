...
const ResearchCMS = () => {
 ...
 //   setMarkdown(value); // You can use a library to convert HTML to Markdown if needed
  ...
  const [selectedOption, setSelectedOption] = React.useState('Applied Research');
    ...
    if(title !="" && content !=""  && selectedOption!=""){
      ...
      try {
       ...
       // create new guest post
        axios.post('https://www.back.kemet.care/api/cms/new_post', formData )
  ...
  return (
    <div >
      ...
      <div className="w-screen h-screen px-4 py-4">
       ...
       <p className='font-medium text-2xl'>Add New Content - <span className='text-zinc-500'>R&D</span></p>
